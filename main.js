document.addEventListener("DOMContentLoaded", function () {
  ...
  function showProductDetail(card) {
    ...
    var whatsappText =
      "أرغب في طلب منتج " + nameText + " من MALORA Body Splash";
    ...
    if (productDetailInstagram) {
      productDetailInstagram.href = "https://www.instagram.com/mal0ra_/?igsh=MTMzMGxmc2twdDQ0ag%3D%3D&utm_source=qr#";
    }
